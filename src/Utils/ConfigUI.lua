...
function ConfigUI:BuildBlizzardPage(parentFrame)
    ...
    local placeHint = W:CreateLabel(parentFrame,
        "Position and size anything set to sit on the map. Offsets measure " ..
            "inward from the anchor, so they read the same way whichever corner " ..
            "you pick.",
        { font = "GameFontNormalSmall", color = { 0.7, 0.7, 0.7 } })
